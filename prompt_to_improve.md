...
You can find the images for the company products to showcase in the images folder.
```

---
```
yes, please use the same methodology and strategy to carefully continue with the following step by step as per your plan, and complete the following actions without asking me again until completed all the following:
